# Getting help with select

Thanks for using select. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/select/issues) to make sure the 
